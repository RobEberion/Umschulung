...
<label for="termnr">TerminID: </label><input type="text" id="termnr" name="termnr" value="<?php echo $termnr; ?>" disabled/><br />
<label for="kursnr">Kurs: </label><?php echo $termin->einfSelect("kurse", "kursnr", "titel", $tData['kursnr']); ?><br />
...
<p><a class="button" href="terminloeschen.php?termnr=<?php echo $termnr; ?>">Termin löschen</a></p>
<?PHP
}
else {
 ?> 
...
<label for="termnr">TerminID: </label><input type="text" id="termnr" name="termnr" value="AUTO" disabled /><br />
<label for="kursnr">Kurs: </label><?php echo $termin->einfSelect("kurse", "kursnr", "titel", Null); ?><br />
